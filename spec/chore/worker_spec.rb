...
describe Chore::Worker do
  ...
  it 'should process multiple jobs' do
    work = []
    10.times do |i|
      work << Chore::UnitOfWork.new(i, Chore::JsonEncoder.encode(job), 0, consumer)
    end
  ...
  describe 'with errors' do
    context 'on parse' do
      ...
      it 'should fail cleanly' do
        work = Chore::UnitOfWork.new(2,job,0,consumer)
      ...
      context 'more than the maximum allowed times' do
        ...
        it 'should permanently fail' do
          work = Chore::UnitOfWork.new(2,job,9,consumer)
          Chore.should_receive(:run_hooks_for).with(:on_permanent_failure, job, anything())
          Chore::Worker.start(work)
        end
    ...
    context 'on perform' do
      ...
      it 'should fail cleanly' do
        work = Chore::UnitOfWork.new(2,encoded_job,0,consumer)
        consumer.should_not_receive(:complete)
      ...
      context 'more than the maximum allowed times' do
        it 'should permanently fail' do
          work = Chore::UnitOfWork.new(2,encoded_job,999,consumer)
          SimpleJob.should_receive(:run_hooks_for).with(:on_permanent_failure, parsed_job, anything())
          Chore::Worker.start(work)
        end
