...
Other options include:
    ...
    --dedupe-strategy # Setting this value to "strict" means that when memcache is down, we assume that the message is a duplicate. Defaults to "loose", which assumes the message is not a duplicate.
