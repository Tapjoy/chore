...
Other options include:
    ...
    --consumer_sleep_interval The amount of time in seconds (floats are accepted) to sleep when a consumer doesn't receive any messages. The default varies by implementation. This is a weak form of backoff for when there is no work to do.
